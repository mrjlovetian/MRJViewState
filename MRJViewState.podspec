...
Pod::Spec.new do |s|
  s.name             = 'MRJViewState'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MRJViewState.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/mrjlovetian@gmail.com/MRJViewState'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'mrjlovetian@gmail.com' => 'mrjyuhongjiang@gmail.com' }
  s.source           = { :git => 'https://github.com/mrjlovetian@gmail.com/MRJViewState.git', :tag => s.version.to_s }
